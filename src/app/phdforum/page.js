...
const PhDForumBanner = () => {
  return (
    <section
      className="relative flex items-center justify-center text-center py-10 md:py-10"
      style={{
    ...
    >
      ...
      <div className="relative z-10 px-4 max-w-4xl mx-auto">
        <div className="mb-4">
          ...
          <h2 className="text-2xl md:text-3xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-purple-300 to-indigo-200 mb-3">
            Doctoral Research Symposium
          </h2>
          <h2 className="text-xl md:text-2xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-indigo-300 to-purple-200 mb-8">
...
const Icon = ({ name, className = "w-4 h-4 flex-shrink-0" }) => {
  const iconStyles = {
    ...
    <div className="relative py-8 px-4 bg-gray-900 rounded-xl shadow-md mb-4 overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        <div className="text-center mb-6">
          ...
          <h2 className="text-xl md:text-2xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-indigo-400 to-purple-400 mb-2">
            Important Dates
          </h2>
          <div className="h-1 w-16 bg-gradient-to-r from-indigo-500 to-purple-500 mx-auto"></div>
          ...
          {dates.map((item, index) => (
            <div key={index} className="mb-4 flex">
              <div className="w-20 flex-shrink-0 flex flex-col items-center">
                <div className="h-8 w-8 rounded-full bg-gradient-to-r from-indigo-700 to-purple-700 flex items-center justify-center shadow-lg">
              ...
              <div className="bg-gradient-to-r from-black to-gray-900 bg-opacity-50 p-3 rounded-lg border-l-4 border-indigo-600 flex-grow hover:shadow-lg transition-all transform hover:-translate-y-1">
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        <div className="text-center mb-6">
          <div className="inline-block bg-gradient-to-r from-purple-900 to-indigo-900 p-2 rounded-full mb-6">
            <Icon name="format" className="w-6 h-6" />
          </div>
          <h2 className="text-xl md:text-2xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-indigo-400 mb-2">
        ...
        <div className="bg-black bg-opacity-40 p-4 rounded-xl border border-purple-800 max-w-4xl mx-auto backdrop-blur-sm">
          ...
          <div>
            ...
            <p className="text-gray-200 text-sm ">15-minute in-person presentation at the conference venue</p>
          </div>
        </div>
      </div>
    </div>
        ...
        <div className="max-w-4xl mx-auto grid gap-4">
          {faqs.map((faq, index) => (
            <div key={index} className="bg-black bg-opacity-40 border border-purple-800 rounded-lg p-6 hover:shadow-lg transition-all">
              <h3 className="text-lg font-semibold text-purple-300 mb-2">{faq.question}</h3>
...
const CallToAction = () => {
  return (
    <div className="relative py-12 px-4 bg-gradient-to-br from-indigo-900 to-purple-900 rounded-xl shadow-lg overflow-hidden">
