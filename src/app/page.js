...
// Guest of Honour Section — Dr. Kamaljeet Singh
        ...
        <div className="flex flex-col md:flex-row items-center gap-10 md:gap-16">
          ...
          <div className="flex-shrink-0 flex flex-col items-center">
            <div className="relative group">
              ...
              <div className="absolute -inset-1.5 bg-gradient-to-tr from-yellow-400 via-orange-400 to-purple-500 rounded-full"></div>
              {/* Photo */}
              <div className="relative w-52 h-52 sm:w-64 sm:h-64 md:w-72 md:h-72 rounded-full overflow-hidden border-4 border-white/20 shadow-2xl bg-white">
                <Image
                  src="/images/kamaljeetsingh.jpeg"
                  alt="Dr. Kamaljeet Singh"
                  layout="fill"
                  objectFit="cover"
                  className="rounded-full"
                  priority
          ...
          <div className="flex-1 text-center md:text-left">
            ...
            <p className="text-base sm:text-lg text-gray-300 mb-6">
              Semi-Conductor Laboratory, Ministry of Electronics &amp; Information Technology
            </p>
            ...
            <p className="text-gray-300 text-base sm:text-lg leading-relaxed max-w-xl mx-auto md:mx-0">
              We are deeply honoured to welcome <span className="text-yellow-300 font-semibold">Dr. Kamaljeet Singh</span> as the Guest of Honour. 
              His leadership at the Semi-Conductor Laboratory is playing a pivotal role in advancing India&apos;s electronics and semiconductor ecosystem.
            </p>
