...
const schedule = [
  {
    ...
    rows: [
      ...
      },
      {
        ...
        duration: "60 min",
        type: "Poster Session/ Open House",
        session: "Poster Session/ Open House",
        speaker: "Satya Chitra , Aparajita and Ashish (Renesas)",
        audience: "Poster area and Auditorium",
      },
      {
